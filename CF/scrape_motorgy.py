...
def scrape_all() -> None:
    # --- Cloudflare R2 credentials (always explicit, no fallback chain) ---
    ...
    if part_label:
        r2_prefix = f"{r2_prefix}/part={part_label}"
    ...
    print("Starting Motorgy scrape (Cloudflare R2)...")
    ...
    # --- R2 client: requires endpoint_url, path-style addressing, and explicit s3v4 sig ---
